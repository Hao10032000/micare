...
function themesflat_setup() {
     ...
     * to change 'micare' to the name of your theme in all the template files
     */
    load_theme_textdomain( 'micare', THEMESFLAT_DIR . '/languages' );
    ...
    register_nav_menus( array(
        'primary' => esc_html__( 'Primary Menu', 'micare' ),
        'bottom' => esc_html__( 'Bottom Menu', 'micare' ),
        'onepage' => esc_html__( 'One Page Menu', 'micare' )
    ) );
...
function themesflat_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar Blog', 'micare' ),
        'id'            => 'blog-sidebar',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Blog Sidebar.', 'micare' ),
    ...
    //Widget footer
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 1', 'micare' ),
        'id'            => 'footer-1',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 1.', 'micare' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 2', 'micare' ),
        'id'            => 'footer-2',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 2.', 'micare' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 3', 'micare' ),
        'id'            => 'footer-3',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 3.', 'micare' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 4', 'micare' ),
        'id'            => 'footer-4',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer widget area 4.', 'micare' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar Toggler', 'micare' ),
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Services Sidebar', 'micare' ),
...
function themesflat_scripts() {    
    // Theme stylesheet.    
    wp_enqueue_style( 'icon-micare', THEMESFLAT_LINK . 'css/icon-micare.css' );
...
function micare_elementor_setup() {
...
add_action( 'after_switch_theme', 'micare_elementor_setup' );
