...
$links = paginate_links( array(
	...
	'prev_text' => ( '<i class="icon-micare-angles-left1"></i>' ),
	'next_text' => ( '<i class="icon-micare-angles-left"></i>' ),
) );
...
$next_link = get_next_posts_link( esc_html__( 'Next', 'micare' ) );
$prev_link = get_previous_posts_link( esc_html__( 'Previous', 'micare' ) );
$loadmore_text = apply_filters('themesflat/template/loadmore_text',esc_html__('Load More','micare'));
