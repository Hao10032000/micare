...
if (class_exists('WP_Customize_Control')) {
	...
	class themesflat_Typography extends WP_Customize_Control {
		...
		public function render_content() {
			$this->titles = array(
				'100'        => esc_html__( 'Thin 100', 'micare' ),
				'100italic'  => esc_html__( 'Thin 100 italic', 'micare' ),
				'200'        => esc_html__( 'Extra-light 200', 'micare' ),
				'200italic'  => esc_html__( 'Extra-light 200 italic', 'micare' ),
				'300'        => esc_html__( 'Light 300', 'micare' ),
				'300italic'  => esc_html__( 'Light 300 italic', 'micare' ),
				'400'        => esc_html__( 'Normal 400', 'micare' ),
				'400italic'  => esc_html__( 'Normal 400 italic', 'micare' ),
				'regular'    => esc_html__( 'Normal 400', 'micare' ),
				'italic'     => esc_html__( 'Normal 400 italic', 'micare' ),
				'500'        => esc_html__( 'Medium 500', 'micare' ),
				'500italic'  => esc_html__( 'Medium 500 italic', 'micare' ),
				'600'        => esc_html__( 'Semi-bold 600', 'micare' ),
				'600italic'  => esc_html__( 'Semi-bold 600 italic', 'micare' ),
				'700'        => esc_html__( 'Bold 700', 'micare' ),
				'700italic'  => esc_html__( 'Bold 700 italic', 'micare' ),
				'800'        => esc_html__( 'Extra-bold 800', 'micare' ),
				'800italic'  => esc_html__( 'Extra-bold 800 italic', 'micare' ),
				'900'        => esc_html__( 'Ultra-bold 900', 'micare' ),
				'900itallic' => esc_html__( 'Ultra-bold 900 italic', 'micare' )
			);

			$this->titles_subsets = array(
				"cyrillic-ext"  => esc_html__("Cyrillic Extended",'micare'),
			    "greek" 		=> esc_html__("Greek",'micare'),
			    "greek-ext"		=>	esc_html__("Greek Extended",'micare'),
			    "latin-ext"		=>	esc_html__("Latin Extended",'micare'),
			    "cyrillic"		=>	esc_html__("Cyrillic",'micare'),
			    "vietnamese"	=>	esc_html__("Vietnamese",'micare'),
			    "latin" 		=> esc_html__("Latin",'micare')
				);
			...
			<div class="themesflat-options-control-inputs">					
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-font">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-family"><?php esc_html_e( 'Font Family', 'micare' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<select name="<?php  echo esc_attr( $name ) ?>[family]" id="<?php  echo esc_attr( $name ) ?>-family" class="select-choosen" >
							<optgroup label="<?php echo esc_html( 'Google Fonts', 'micare' ) ?>">
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-style">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Weight & Style', 'micare' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<label>
				...
				<?php if ( in_array( 'subsets', $this->fields ) ): ?>
					<div class="themesflat-options-control typography-subsets themesflat-options-control-switcher active">
						<div class="themesflat-options-control-title customize-control-title">
							<label><?php esc_html_e( 'Font subsets', 'micare' ) ?></label>
						</div>
						<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-size">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-size"><?php esc_html_e( 'Font Size (px)', 'micare' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-line_height">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-line_height"><?php esc_html_e( 'Line height ( ex: 25px or 1.8 or 150% )', 'micare' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-letter_spacing">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-letter_spacing"><?php esc_html_e( 'Letter Spacing ( Value in px or em )', 'micare' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group themesflat-options-control-color-picker typography-color">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Color', 'micare' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
