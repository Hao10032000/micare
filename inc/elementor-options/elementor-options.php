...
class themesflat_options_elementor {
    ...
    public function themesflat_options_page_header($element) {
        ...
        $element->start_controls_section(
            ...
            [
                'label' => esc_html__('TF Header', 'micare'),
        ...
        $element->add_control(
            'h_options_topbar',
            [
                'label' => esc_html__( 'Topbar', 'micare' ),
        ...
        $element->add_control(
            'topbar_show',
            [
                'label'     => esc_html__( 'Top Bar', 'micare'),
                'type'      => Controls_Manager::SELECT,
                'default'   => '',
                'options'   => [
                    '' => esc_html__( 'Theme Setting', 'micare'),
                    0       => esc_html__( 'Hide', 'micare'),
                    1       => esc_html__( 'Show', 'micare'),                    
                ],
            ]
        ); 
        ...
        $element->add_control(
            ...
            [
                ...
                'options'   => [
                	'' => esc_html__( 'Theme Setting', 'micare'),
                    'topbar-default' => esc_html__( 'TopBar Default', 'micare'),
                    'topbar-01' => esc_html__( 'TopBar 01', 'micare'),
                ],
                'condition' => [
                    'topbar_show' => '1',
                ],
        ...
        $element->add_control(
            'social_topbar',
            [
                'label'     => esc_html__( 'Social Top Bar', 'micare'),
                'type'      => Controls_Manager::SELECT,
                'default'   => '',
                'options'   => [
                    '' => esc_html__( 'Theme Setting', 'micare'),
        ...
        $element->add_control (
            'topbar_address2',
            [
                'label' => esc_html__( 'Top Bar Address', 'micare' ),
        ...
        $element->add_control(
            'topbar_height',
            [
                'label' => esc_html__( 'Top Bar Height', 'micare' ),
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Background', 'micare' ),
        ...
        $element->add_control(
            'topbar_link_color',
            [
                'label' => esc_html__( 'Link Color', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Link Hover Color', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            'h_options_header',
            [
                'label' => esc_html__( 'Header', 'micare' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $element->add_control(
            'site_logo',
            [
                'label'   => esc_html__( 'Custom Logo', 'micare' ),
        ...
        $element->add_control(
            'site_logo_sticky',
            [
                'label'   => esc_html__( 'Custom Logo Fixed', 'micare' ),
                'type'    => Controls_Manager::MEDIA,
            ]
        );
        $element->add_responsive_control(
            'logo_width',
            [
                'label'      => esc_html__( 'Logo Width', 'micare' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range'      => [
                    'px' => [
        ...
        $element->add_group_control(
            ...
            [
                'name' => 'logo_bg_color',
                'label' => esc_html__( 'Logo Background Color', 'micare' ),
                'types' => ['gradient' ],
        ...
        $element->add_control(
            'header_absolute',
            [
                'label'     => esc_html__( 'Header Absolute', 'micare'),
                'type'      => Controls_Manager::SELECT,
                'default'   => '',
                'options'   => [
                    '' => esc_html__( 'Theme Setting', 'micare'),
                    0       => esc_html__( 'No', 'micare'),
                    1       => esc_html__( 'Yes', 'micare'),                    
                ],
        ...
        $element->add_control(
            'header_sticky',
            [
                'label'     => esc_html__( 'Header Sticky', 'micare'),
                'type'      => Controls_Manager::SELECT,
                'default'   => '',
                'options'   => [
                    '' => esc_html__( 'Theme Setting', 'micare'),
        ...
        $element->add_control(
            'onepage_menu',
            [
                'label'     => esc_html__( 'Enable OnePage Menu', 'micare'),
                'type'      => Controls_Manager::SELECT,
                'default'   => '',
                'options'   => [
                    '' => esc_html__( 'Theme Setting', 'micare'),
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Header Background', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Header Background Sticky', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            'header_color_sticky',
            [
                'label' => esc_html__( 'Header Color Sticky', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            'header_height',
            [
                'label' => esc_html__( 'Header Height', 'micare' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Button Search & Toggle', 'micare' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $element->add_control(
            'header_search_box',
            [
                'label'     => esc_html__( 'Search Box', 'micare'),
                'type'      => Controls_Manager::SELECT,
                'default'   => '',
                'options'   => [
                    '' => esc_html__( 'Theme Setting', 'micare'),
        ...
        $element->add_control(
            ...
            [
                'label'     => esc_html__( 'Sidebar Toggler', 'micare'),
                'type'      => Controls_Manager::SELECT,
                'default'   => '',
                'options'   => [
                    '' => esc_html__( 'Theme Setting', 'micare'),
        ...
        $element->add_control(
            'search_toggle_color',
            [
                'label' => esc_html__( 'Search & Toggle Color', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Search & Toggle Color Hover', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Search & Toggle Color Sticky', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Search & Toggle Color Hover Sticky', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            'mainnav_hover_color',
            [
                'label' => esc_html__( 'Link Hover & active Color', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            'mainnav_space',
            [
                'label' => esc_html__( 'MainNav Space', 'micare' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $element->add_control(
            'h_options_nav_sub',
            [
                'label' => esc_html__( 'Sub Menu', 'micare' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $element->add_control(
            'sub_nav_color',
            [
                'label' => esc_html__( 'SubMenu Color', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            'sub_nav_color_hover',
            [
                'label' => esc_html__( 'SubMenu Color Hover', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            'sub_nav_background',
            [
                'label' => esc_html__( 'SubMenu Background Color', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'SubMenu Background Color Hover', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'SubMenu Border Color', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            'h_options_nav_inner',
            [
                'label' => esc_html__( 'Sub Inner Menu', 'micare' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $element->add_control(
            'sub_sub_nav_color',
            [
                'label' => esc_html__( 'Sub Inner Color', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Sub Inner Color Hover', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Sub Inner Background Color', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Sub Inner Background Color Hover', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            'h_options_Infor',
            [
                'label' => esc_html__( 'Information Header', 'micare' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $element->add_control(
            'header_infor_phone',
            [
                'label'     => esc_html__( 'Header Infor Contact', 'micare'),
                'type'      => Controls_Manager::SELECT,
                'default'   => '',
                'options'   => [
                    '' => esc_html__( 'Theme Setting', 'micare'),
        ...
        $element->add_control(
            'infor_color',
            [
                'label' => esc_html__( 'Infor Color Label', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            'infor_hd_color',
            [
                'label' => esc_html__( 'Infor Color', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control (
            ...
            [
                'label' => esc_html__( 'Infor Contact Icon', 'micare' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'label_block' => true,
                'condition' => [ 'style_header' => 'header-02' ],
            ]
        ...
        $element->add_control (
            ...
            [
                'label' => esc_html__( 'Infor Contact', 'micare' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'label_block' => true,
            ]
        );
        ...
        $element->add_control (
            'topbar_email_label',
            [
                'label' => esc_html__( 'Email Icon', 'micare' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'label_block' => true,
                'condition' => [ 'style_header' => 'header-02' ],
            ]
        ...
        $element->add_control (
            'topbar_email',
            [
                'label' => esc_html__( 'Email Infor', 'micare' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'label_block' => true,
                'condition' => [ 'style_header' => 'header-02' ],
            ]
        ...
        $element->add_control (
            'topbar_address',
            [
                'label' => esc_html__( 'Address Infor', 'micare' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'label_block' => true,
                'condition' => [ 'style_header' => 'header-02' ],
            ]
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Icon Background Color Label', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            'header_infor_color',
            [
                'label' => esc_html__( 'Icon Color Label', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Subtitle Color', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Title Color', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            ...
            [
                'label'   => esc_html__( 'Extra Classes', 'micare' ),
    ...
    public function themesflat_options_page_pagetitle($element) {
        ...
        $element->start_controls_section(
            ...
            [
                'label' => esc_html__('TF Page Title', 'micare'),
                'tab' => Controls_Manager::TAB_SETTINGS,
            ]
        );       
        ...
        $element->add_control(
            'hide_pagetitle',
            [
                'label'     => esc_html__( 'Hide Page Title', 'micare'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'block',
                'options'   => [
                    'none'       => esc_html__( 'Yes', 'micare'),
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Title Margin', 'micare' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'default' => [
                    'top' => '46',
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Overlay Color', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    public function themesflat_options_page_footer($element) {
        ...
        $element->start_controls_section(
            ...
            [
                'label' => esc_html__('TF Footer', 'micare'),
                'tab' => Controls_Manager::TAB_SETTINGS,
            ]
        );
        ...
        $element->add_control(
            'footer_heading',
            [
                'label'     => esc_html__( 'Footer', 'micare'),
                'type'      => Controls_Manager::HEADING,
            ]
        );       
        ...
        $element->add_control(
            'hide_footer',
            [
                'label'     => esc_html__( 'Hide Footer', 'micare'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'block',
                'options'   => [
                    'none'       => esc_html__( 'Yes', 'micare'),
        ...
        $element->add_control(
            'enable_footer_fixed',
            [
                'label'     => esc_html__( 'Footer Sticky', 'micare'),
                'type'      => Controls_Manager::SELECT,
                'default'   => '',
                'options'   => [
                    '' => esc_html__( 'Theme Setting', 'micare'),
                    0       => esc_html__( 'Disable', 'micare'),
                    1       => esc_html__( 'Enable', 'micare'),                    
                ],
            ]
        );
        ...
        $element->add_control(
            'footer_bg_overlay',
            [
                'label' => esc_html__( 'Background Overlay', 'micare' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $element->add_control(
            'bottom_heading',
            [
                'label'     => esc_html__( 'Bottom', 'micare'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before'
            ]
        );
    ...
    public function themesflat_options_page($element) {
        ...
        $element->start_controls_section(
            ...
            [
                'label' => esc_html__('TF Page', 'micare'),
                'tab' => Controls_Manager::TAB_SETTINGS,
            ]
        );
        ...
        $element->add_control(
            ...
            [
                ...
                'options'   => [
                    ...
                    'fullwidth-small'   =>   esc_html__( 'Full Width Small','micare' ),
                    'fullwidth-center'  =>   esc_html__( 'Full Width Center','micare' ),
                ],
            ]
        );
        ...
        $element->add_control(
            ...
            [
                'label'     => esc_html__( 'Main Content', 'micare'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before'
            ]
        );
    ...
    public function themesflat_options_services($element) {
        ...
        $element->start_controls_section(
            ...
            [
                'label' => esc_html__('TF Services', 'micare'),
                'tab' => Controls_Manager::TAB_SETTINGS,
            ]
        );
        ...
        $element->add_control(
            ...
            [
                'label'     => esc_html__( 'Style Services Single', 'micare'),
                'type'      => Controls_Manager::SELECT,
                'default'   => '',
                'options'   => [
                    '' => esc_html__( 'Theme Setting', 'micare'),
