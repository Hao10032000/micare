...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        array(
            ...
            'description'   => esc_html__(' Opacity =1 for Background Color', 'micare'),
...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        'header_background_bottom_color',
        array(
            'label'         => esc_html__('Header Background Bottom', 'micare'),
            'description'   => esc_html__('Only Style Header 02', 'micare'),
            'section'       => 'color_header',
            'priority'      => 1
        )
    )
...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        'header_backgroundcolor_sticky',
        array(
            'label'         => esc_html__('Sticky Header Background', 'micare'),
            'section'       => 'color_header',
            'priority'      => 2
        )
    )
...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        'header_color_sticky',
        array(
            'label'         => esc_html__('Sticky Header Color Menu', 'micare'),
            'section'       => 'color_header',
            'priority'      => 3
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'mainnav_color',
        array(
            'label' => esc_html__('Menu color', 'micare'),
            'section' => 'color_header',
            'priority' => 4
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'mainnav_hover_color',
        array(
            'label' => esc_html__('Menu Hover', 'micare'),
            'section' => 'color_header',
            'priority' => 5
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'mainnav_active_color',
        array(
            'label' => esc_html__('Menu Active', 'micare'),
            'section' => 'color_header',
            'priority' => 6
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_nav_color_hover',
        array(
            'label' => esc_html__('SubMenu Hover & Active', 'micare'),
            'section' => 'color_header',
            'priority' => 24
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_nav_background',
        array(
            'label' => esc_html__('SubMenu Background', 'micare'),
            'section' => 'color_header',
            'priority' => 25
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_nav_background_hover',
        array(
            'label' => esc_html__('SubMenu Background Hover & Active', 'micare'),
            'section' => 'color_header',
            'priority' => 26
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_nav_border_color',
        array(
            'label' => esc_html__('SubMenu Border Line', 'micare'),
            'section' => 'color_header',
            'priority' => 27
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_sub_nav_color',
        array(
            'label' => esc_html__('SubMenu Child color', 'micare'),
            'section' => 'color_header',
            'priority' => 28
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_sub_nav_color_hover',
        array(
            'label' => esc_html__('SubMenu Child Hover & Active', 'micare'),
            'section' => 'color_header',
            'priority' => 29
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_sub_nav_background',
        array(
            'label' => esc_html__('SubMenu Child Background', 'micare'),
            'section' => 'color_header',
            'priority' => 30
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_sub_nav_background_hover',
        array(
            'label' => esc_html__('SubMenu Child Background Hover & Active', 'micare'),
            'section' => 'color_header',
            'priority' => 31
        )
    )
