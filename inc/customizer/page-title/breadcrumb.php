...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Breadcrumb ( OFF | ON )', 'micare'),
...
$wp_customize->add_control(
    ...
    array(
        'type'      => 'text',
        'label'     => esc_html__('Breadcrumb Prefix', 'micare'),
        'section'   => 'section_breadcrumb',
        'priority'  => 2
    )
);  
...
$wp_customize->add_control(
    ...
    array(
        'type'      => 'text',
        'label'     => esc_html__('Breadcrumb Separator', 'micare'),
        'section'   => 'section_breadcrumb',
        'priority'  => 3
    )
);
...
$wp_customize->add_control(
    ...
    array(
        'type'      => 'textarea',
        'label'     => esc_html__('Breadcrumb Description', 'micare'),
        'section'   => 'section_breadcrumb',
        'priority'  => 4
    )
); 