...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Heading ( OFF | ON )', 'micare'),
...
$wp_customize->add_control( new themesflat_Info( $wp_customize, 'page-title-style', array(
    'label' => esc_html__('Page Title Style', 'micare'),
    'section' => 'section_page_title',
...
$wp_customize->add_control( 
    ...
    array (
        ...
        'label'         => esc_html__('Page Title Style', 'micare'),
        'choices'   => array (
            'inline' =>  esc_html__( 'Inline Heading & Breadcrumbs','micare' ),
            'default' =>  esc_html__( 'Default','micare' ),
            'video' =>  esc_html__( 'Video','micare' )
            ) ,
    )
);
...
$wp_customize->add_control( 
    ...
    array (
        ...
        'section'   => 'section_page_title',
        'priority'  => 22,
        'label'         => esc_html__('Page Title Alignment', 'micare'),
        'choices'   => array (
            'left' =>  esc_html__( 'Left','micare' ),
            'center' =>  esc_html__( 'Center','micare' ),
            'right' =>  esc_html__( 'Right','micare' )
            ) ,
    )
); 
...
$wp_customize->add_control(
    new WP_Customize_Image_Control(
        ...
        'page_title_background_image',
        array(
           'label'          => esc_html__( 'Upload Background Image', 'micare' ),
           'type'           => 'image',
           'section'        => 'section_page_title',
           'priority'       => 23,
        )
...
$wp_customize->add_control( 
    ...
    array (
        ...
        'section'   => 'section_page_title',
        'priority'  => 24,
        'label'         => esc_html__('Page Title Image Size', 'micare'),
        'choices'   => array (
            'auto' =>  esc_html__( 'Original','micare' ),
            'contain' =>  esc_html__( 'Fit to Screen','micare' ),
            'cover' =>  esc_html__( 'Fill Screen','micare' )
            ) ,
    )
);
...
$wp_customize->add_control(
    ...
    array(
        'type'      => 'text',
        'label'     => esc_html__('Page Title Background Video URL', 'micare'),
        'section'   => 'section_page_title',
        'priority'  => 25
    )
);
...
$wp_customize->add_control( new themesflat_BoxControls($wp_customize,
    'page_title_controls',
    array(
        'label' => esc_html__( 'Page Title Controls (px)', 'micare' ),
        'section' => 'section_page_title',
        'type' => 'box-controls',
        'priority' => 28
    ))
